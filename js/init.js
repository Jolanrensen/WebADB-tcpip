    ...
    $(function () {
        ...
        function updateState(newState) {
            ...
            switch (newState) {
                case "initial":
                    ...
                    break;
                case "connecting":
                    $connecting.css({display: ""});
                    $forceDisconnect.css({display: ""});
                ...
                case "finished":
                    ...
                    $("#your_ip").text(`Your device should be available at: ${deviceIP.trim()}:${devicePort}`);
                    $disconnect.focus();
                    break;
            }
        }
        ...
        let get_ip = async () => {
            try {
                ...
                let shell = await adb.shell("ip addr show wlan0 | grep \"inet\\s\" | awk '{print $2}' | awk -F'/' '{print $1}'");
